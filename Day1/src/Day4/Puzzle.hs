...
instance Show a => Show (WakeEvent a) where
...
toWakeEvents (SleepRange (SpanRange (Bound a _) (Bound b _))) =
...
instance Show (Shift [SleepRange]) where
...
instance Ord (Shift [SleepRange]) where
